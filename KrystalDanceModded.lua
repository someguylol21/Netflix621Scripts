...
local thirdThing = game:GetObjects('rbxassetid://129996488202962')[1]
...
ghostUpdateConn = RunService.PreSimulation:Connect(function()
    if char and char.PrimaryPart and ghostRig then
        ghostRig:SetPrimaryPartCFrame(char.HumanoidRootPart.CFrame * CFrame.new(0,-0.5,0))
...
local idToEmote = {
    ...
    [136139381223407] = {"Dancing In",    "dancingin.mp3",    1,    1,  14},
    [110403709064010] = {"Dr",            "dr.wav",           1,    1,   4},
    [114928062507098] = {"Griddy",        "griddy.mp3",       1,    1,   4},
    [94534967284996]  = {"Lux",           "lux.ogg",          1,    1,  14},
    [86634257330162]  = {"Kazotky",       "kazot.mp3",        1,    1,  14},
    [76647570617571]  = {"SpongeBob Dance", "rbxassetid://1846368080", 0.75, 1, 14},
    ...
    [124616782933406] = {"Balls",         "balls.mp3",        1,    1,  14},
    ...
    [114660931657915] = {"Dancing Wit",   "dancingwit.mp3",   0.75, 1,  14},
    ...
    [77920672554221]  = {"Duck",          "duck.mp3",         1,    1,  14},
